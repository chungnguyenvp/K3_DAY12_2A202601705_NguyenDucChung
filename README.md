...
![CI](https://github.com/chungnguyenvp/K3_DAY12_2A202601705_NguyenDucChung/actions/workflows/ci.yml/badge.svg)
...
- [x] Repo đã được xác nhận đúng theo quy ước của lớp
